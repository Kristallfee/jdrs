...
class TMrfGal_Udp : virtual public TMrfGal
{
    public:
        ...
        */
        virtual int doIoctl(const int ) const;
        ...
        */
         ...
         */
        virtual void enableIRQ(const u_int32_t& ) const {}
        virtual void disableIRQ(const u_int32_t& ) const {}
        virtual u_int32_t waitforIRQ(const u_int32_t& ) { return 0; }
        virtual u_int32_t getIRQ(const u_int32_t& ) { return 0; }
        virtual u_int32_t waitforIRQFast(const u_int32_t& ) const { return 0; }
        virtual u_int32_t getIRQFast(const u_int32_t& ) const { return 0; }
        virtual void ackIRQFast(u_int32_t ) const {}
        virtual u_int32_t getLastInterrupt() const { return 0; }
    ...
    private:
        ...
        /*!
          ...
          \return 0 if everything went well, -1 if an error occured, -2 if the request was timed out.
          */
        virtual int _readBuffer(char* const data, u_int32_t length, u_int64_t &cmdword, u_int32_t* wordcount = 0) const;
        ...
        const static int _UDPrecvTimeout = 50;

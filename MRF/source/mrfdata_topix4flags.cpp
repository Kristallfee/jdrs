...
TMrfData_Topix4Flags::TMrfData_Topix4Flags(const u_int32_t& blocklength, const u_int32_t& defaultindex, const u_int32_t& defaultstreamoffset, const u_int32_t& defaultvalueoffset, const bool& defaultreverse, const bool& defaultstreamreverse)
: TMrfDataAdv1D(blocklength, defaultindex, defaultstreamoffset, defaultvalueoffset, defaultreverse, defaultstreamreverse)
{
	initMaps();
}

void TMrfData_Topix4Flags::initMaps()
{
        _localdata.clear();
        ...
        _localdata["TopixWait"]             = TConfItem(0,12, 1);
        _localdata["SdataOutputFifoReset"]  = TConfItem(0,13, 1);
        _localdata["Bit14"]                 = TConfItem(0,14, 1);
        _localdata["TopixClockMux"]         = TConfItem(0,15, 1);

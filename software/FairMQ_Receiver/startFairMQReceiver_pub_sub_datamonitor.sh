...
bigcounter="0"
xterm -hold -e /home/ikp1/esch/fairsoft/FairRoot_Mohammad_build/bin/testProxy $ID $numIoThreads $inputSocketType $inputRcvBufSize $inputMethod $inputAddress $outputSocketType $outputSndBufSize $outputMethod $outputAddress &
